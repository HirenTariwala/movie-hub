...
export default function CreateMoviePage() {
  ...
  return (
    <div className="min-h-screen max-w-[1248px] md:py-[120px] py-20 m-auto px-[24px]">
      ...
      <div className="grid md:grid-cols-[1fr_1.27fr] max-md:!grid-rows-[auto] grid-cols-1 max-md:gap-6 sm:grid-rows-3 grid-rows-3 lg:gap-x-[127px] md:gap-x-10  max-md:pb-20">
        <div
          {...getRootProps()}
          className=" h-[372px] md:h-[504px] text-center row-span-3 border-2 max-md:order-1 border-dashed bg-[#2A4B55] border-white rounded-[10px] flex justify-center items-center cursor-pointer bg-#224957"
        >
          <input {...getInputProps()} />
        ...
        <div className="flex max-md:order-2 max-md:pt-4 gap-4 h-fit">
